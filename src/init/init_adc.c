...
volatile uint16_t adc_module_init(void) {
...
volatile uint16_t adc_vin_init(void) {
...
volatile uint16_t adc_vout_init(void) {
...
volatile uint16_t adc_vref_ext_init(void) {
...
volatile uint16_t adc_module_start(void) {
